...
temp(REAL(KIND=JPRB),ZEOSO,(KLON))
temp(REAL(KIND=JPRB),ZNSOR,(KLON))
temp(REAL(KIND=JPRB),ZP,(KLON))
temp(REAL(KIND=JPRB),ZDU,(KLON,4))
temp(REAL(KIND=JPRB),ZS_U,(KLON,3))
temp(REAL(KIND=JPRB),ZS_PU,(KLON,3))
temp(REAL(KIND=JPRB),ZS_TU,(KLON,3))
temp(REAL(KIND=JPRB),ZS_UW,(KLON,3))
temp(REAL(KIND=JPRB),ZS_US,(KLON,3))
temp(REAL(KIND=JPRB),ZS_US_IRHOV,(KLON,3))
temp(REAL(KIND=JPRB),ZS_UC,(KLON))
...
temp(REAL(KIND=JPRB),ZMD_W,(KLON))
temp(REAL(KIND=JPRB),ZMD_S,(KLON))
...
temp(REAL(KIND=JPRB),ZTAU,(KLON,3))
...
#define FGTS_DELTA0 YDPHY3%FGTS_DELTA0
#define FGTS_OC     YDPHY3%FGTS_OC
#define FGTS_OB     YDPHY3%FGTS_OB
#define FGTS_OA     YDPHY3%FGTS_OA
#define FGTS_OD     YDPHY3%FGTS_OD
#define FGTS_P00    YDPHY3%FGTS_P00
#define FGTS_Q      YDPHY3%FGTS_Q
#define FGTS_P      YDPHY3%FGTS_P
#define FGTS_ALPHA  YDPHY3%FGTS_ALPHA
#define FGTS_D      YDPHY3%FGTS_D
#define FGTS_A      YDPHY3%FGTS_A
#define FGTS_C      YDPHY3%FGTS_C
#define FGTS_B      YDPHY3%FGTS_B

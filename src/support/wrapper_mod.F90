...
!$acc data copy &
!$acc (YDERDI,YDRIP,YDML_PHY_MF,PAPRS,PAPRSF,PCP,PR,PDELP,PNEB, PQ,PQCO2,PQICE,PQLI,PQO3,PT, &
!$acc  PALB,PALBDIR,PEMIS,PGELAM, PGEMU,PMU0,PMU0LU,PTS,PDECRD,PCLCT, &
!$acc  PGDEOSI,PGUEOSI,PGMU0,PGMU0_MIN,PGMU0_MAX, PGDEOTI,PGDEOTI2,PGUEOTI,PGUEOTI2,PGEOLT,PGEOXT, &

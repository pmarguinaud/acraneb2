# makefile for acraneb2 test program
...
FC=gfortran
#FCOPTS=-O0 -fconvert=swap -fdefault-real-8 -m64 -fpic -fbacktrace -g
FCOPTS=-O3 -fconvert=swap -fdefault-real-8 -fopenmp

all: main

main: main.o ac_cloud_model2.o acraneb2.o acraneb_coefs.o acraneb_coeft.o acraneb_solvs.o acraneb_solvt3.o acraneb_solvt.o acraneb_transs.o acraneb_transt.o
	$(FC) -o main $(FCOPTS) *.o
...
wrapper_mod.o:  model_physics_mf_mod.o parkind1.o yomrip.o yoerdi.o check_acraneb2_mod.o prepare_acraneb2_mod.o wrapper_mod.F90

...
REAL(KIND=JPRB), ALLOCATABLE, DIMENSION(:,:,:,:) :: PGDEOSI, PGUEOSI
REAL(KIND=JPRB), ALLOCATABLE, DIMENSION(:,:,:)   :: PGMU0
REAL(KIND=JPRB), ALLOCATABLE, DIMENSION(:,:)     :: PGMU0_MIN, PGMU0_MAX
REAL(KIND=JPRB), ALLOCATABLE, DIMENSION(:,:,:)   :: PGDEOTI, PGDEOTI2, PGUEOTI, PGUEOTI2, PGEOLT, PGEOXT, PGRPROX, PGMIXP, PGFLUXC
REAL(KIND=JPRB), ALLOCATABLE, DIMENSION(:,:)     :: PGRSURF
!!

...
SUBROUTINE ACRANEB2( &
! - INPUT
 & YDERDI,YDRIP,YDML_PHY_MF,KIDIA0,KFDIA0,KLON,KTDIA,KLEV,KJN,KSTEP, &
! - INPUT 2D
...
INTEGER(KIND=JPIM),INTENT(IN) :: KIDIA0
INTEGER(KIND=JPIM),INTENT(IN) :: KFDIA0
...
temp (REAL (KIND=JPRB),ZDRB,(KLON))
temp (REAL (KIND=JPRB),ZDRS,(KLON))
temp (REAL (KIND=JPRB),ZFLUXE,(KLON))
temp (REAL (KIND=JPRB),ZNMNB,(KLON))
temp (REAL (KIND=JPRB),ZNMNH,(KLON))
temp (REAL (KIND=JPRB),ZNMXB,(KLON))
temp (REAL (KIND=JPRB),ZNMXH,(KLON))
temp (REAL (KIND=JPRB),ZII0,(KLON))
temp (REAL (KIND=JPRB),ZMU0,(KLON))
temp (REAL (KIND=JPRB),ZMU00,(KLON))
...
temp (REAL (KIND=JPRB),ZWEIGHT,(KLON))
temp (REAL (KIND=JPRB),ZRSURF,(KLON))
temp (REAL (KIND=JPRB),ZTRB,(KLON))
temp (REAL (KIND=JPRB),ZTRS,(KLON))
temp (REAL (KIND=JPRB),ZZTRB,(KLON))
temp (REAL (KIND=JPRB),ZZTRS,(KLON))
temp (REAL (KIND=JPRB),ZFRB,(KLON))
temp (REAL (KIND=JPRB),ZFRS,(KLON))
temp (REAL (KIND=JPRB),ZZFRB,(KLON))
temp (REAL (KIND=JPRB),ZZFRS,(KLON))
temp (REAL (KIND=JPRB),ZCOLAT,(KLON))
temp (REAL (KIND=JPRB),ZCOLON,(KLON))
temp (REAL (KIND=JPRB),ZSILON,(KLON))
temp (REAL (KIND=JPRB),ZTAUC,(KLON))
temp (REAL (KIND=JPRB),ZTAUCUN,(KLON))
temp (REAL (KIND=JPRB),ZFRSOPS_TRUE,(KLON))
temp (REAL (KIND=JPRB),ZFRSOPS_UN,(KLON))
...
INTEGER(KIND=JPIM) :: JLON0,KIDIA,KFDIA
...
! stack stuff
!init_stack ()
INTEGER(KIND=8) :: ISTACKPTR; ISTACKPTR = KSTACKPTR

!$acc data &
!$acc&   present( YDERDI,YDRIP,YDML_PHY_MF, &
...
!$acc parallel loop gang vector private(JLON0,KIDIA,KFDIA)
DO JLON0=KIDIA0,KFDIA0
KIDIA=JLON0
KFDIA=JLON0

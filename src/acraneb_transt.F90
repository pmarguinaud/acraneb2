...
INTEGER(KIND=8), INTENT (   IN) :: KSTACKSIZE
INTEGER(KIND=8), INTENT (   IN) :: KSTACKPTR
REAL(KIND=JPRB)   , INTENT (INOUT) :: PSTACK  (KSTACKSIZE)
...
temp(REAL(KIND=JPRB),ZDELP,(KLON))
temp(REAL(KIND=JPRB),ZEOTO,(KLON))
temp(REAL(KIND=JPRB),ZNSOR,(KLON))
temp(REAL(KIND=JPRB),ZP,(KLON))
temp(REAL(KIND=JPRB),ZDU,(KLON,4))
temp(REAL(KIND=JPRB),ZC_U,(KLON,3))
temp(REAL(KIND=JPRB),ZC_PU,(KLON,3))
temp(REAL(KIND=JPRB),ZC_TU,(KLON,3))
temp(REAL(KIND=JPRB),ZC_UW,(KLON,3))
temp(REAL(KIND=JPRB),ZC_US,(KLON,3))
temp(REAL(KIND=JPRB),ZC_US_IRHOV,(KLON,3))
temp(REAL(KIND=JPRB),ZC_UC,(KLON))
temp(REAL(KIND=JPRB),ZT_U,(KLON,3))
temp(REAL(KIND=JPRB),ZT_PU,(KLON,3))
temp(REAL(KIND=JPRB),ZT_TU,(KLON,3))
temp(REAL(KIND=JPRB),ZT_UW,(KLON,3))
temp(REAL(KIND=JPRB),ZT_US,(KLON,3))
temp(REAL(KIND=JPRB),ZT_US_IRHOV,(KLON,3))
temp(REAL(KIND=JPRB),ZT_UC,(KLON))
...
temp(REAL(KIND=JPRB),ZDEL0,(KLON))
temp(REAL(KIND=JPRB),ZDEL1,(KLON))
temp(REAL(KIND=JPRB),ZDEL1D,(KLON,KLEV-1))
temp(REAL(KIND=JPRB),ZTAU,(KLON))
temp(REAL(KIND=JPRB),ZTAU0A,(KLON))
temp(REAL(KIND=JPRB),ZTAU1A,(KLON))
temp(REAL(KIND=JPRB),ZTAU0B,(KLON))
temp(REAL(KIND=JPRB),ZTAU1B,(KLON))
temp(REAL(KIND=JPRB),ZTAU0,(KLON,0:KLEV,0:KLEV))
temp(REAL(KIND=JPRB),ZTAU1,(KLON,0:KLEV,0:KLEV))

temp(REAL(KIND=JPRB),ZDELTA,(KLON,3))
temp(REAL(KIND=JPRB),ZZA,(KLON,3))
temp(REAL(KIND=JPRB),ZAR,(KLON,3))
temp(REAL(KIND=JPRB),ZCOEF,(KLON,3))
temp(REAL(KIND=JPRB),ZZTAU,(KLON,3))
...
CALL DELTA_C(KTDIA-1,ZP,PT(:,KTDIA),ZDU,&
 ...
 & ZDEOTA0(:,KTDIA-1),ZDELTA,ZZA,ZAR,ZCOEF,ZZTAU)
CALL DELTA_T(KTDIA-1,ZP,PT(:,KTDIA),ZDU,&
 & ZT_UW,ZT_US,ZT_US_IRHOV,ZT_UC,ZT_U,ZT_PU,ZT_TU,&
 & ZDEOTA1(:,KTDIA-1),ZDELTA,ZZA,ZAR,ZCOEF,ZZTAU)
DO JLON=KIDIA,KFDIA
...
DO JLEV=KTDIA,KLEV
  ...
  CALL DELTA_C(JLEV,PAPRSF(1,JLEV),PT(1,JLEV),ZDU,&
   & ZC_UW,ZC_US,ZC_US_IRHOV,ZC_UC,ZC_U,ZC_PU,ZC_TU,&
   & ZDEOTA0(1,JLEV),ZDELTA,ZZA,ZAR,ZCOEF,ZZTAU)
  CALL DELTA_T(JLEV,PAPRSF(1,JLEV),PT(1,JLEV),ZDU,&
   & ZT_UW,ZT_US,ZT_US_IRHOV,ZT_UC,ZT_U,ZT_PU,ZT_TU,&
   & ZDEOTA1(1,JLEV),ZDELTA,ZZA,ZAR,ZCOEF,ZZTAU)
  DO JLON=KIDIA,KFDIA
...
DO JLEV=KLEV,KTDIA,-1
  ...
  CALL DELTA_C(JLEV,PAPRSF(1,JLEV),PT(1,JLEV),ZDU,&
   & ZC_UW,ZC_US,ZC_US_IRHOV,ZC_UC,ZC_U,ZC_PU,ZC_TU,&
   & ZUEOTA0(1,JLEV),ZDELTA,ZZA,ZAR,ZCOEF,ZZTAU)
  CALL DELTA_T(JLEV,PAPRSF(1,JLEV),PT(1,JLEV),ZDU,&
   & ZT_UW,ZT_US,ZT_US_IRHOV,ZT_UC,ZT_U,ZT_PU,ZT_TU,&
   & ZUEOTA1(1,JLEV),ZDELTA,ZZA,ZAR,ZCOEF,ZZTAU)
  DO JLON=KIDIA,KFDIA
...
CALL DELTA_C(KTDIA-1,ZP,PT(1,KTDIA),ZDU,&
 & ZC_UW,ZC_US,ZC_US_IRHOV,ZC_UC,ZC_U,ZC_PU,ZC_TU,&
 & ZUEOTA0(1,KTDIA-1),ZDELTA,ZZA,ZAR,ZCOEF,ZZTAU)
CALL DELTA_T(KTDIA-1,ZP,PT(1,KTDIA),ZDU,&
 & ZT_UW,ZT_US,ZT_US_IRHOV,ZT_UC,ZT_U,ZT_PU,ZT_TU,&
 & ZUEOTA1(1,KTDIA-1),ZDELTA,ZZA,ZAR,ZCOEF,ZZTAU)
DO JLON=KIDIA,KFDIA
  PUEOTI(JLON,KTDIA-1)=&
  ...
  DO JLEV1=KTDIA-1,KLEV-1  ! initial half level
    ...
    DO JLEV2=JLEV1+1,ILEV  ! final half level
      ...
      CALL DELTA_C(JLEV2,PAPRSF(1,JLEV2),PT(1,JLEV2),ZDU,&
       & ZC_UW,ZC_US,ZC_US_IRHOV,ZC_UC,ZC_U,ZC_PU,ZC_TU,&
       & ZDEL0,ZDELTA,ZZA,ZAR,ZCOEF,ZZTAU)
      CALL DELTA_T(JLEV2,PAPRSF(1,JLEV2),PT(1,JLEV2),ZDU,&
       & ZT_UW,ZT_US,ZT_US_IRHOV,ZT_UC,ZT_U,ZT_PU,ZT_TU,&
       & ZDEL1,ZDELTA,ZZA,ZAR,ZCOEF,ZZTAU)
...
SUBROUTINE DELTA_C(KL,PRES,PT,PDU,PUW,PUS,PUS_IRHOV,PUC,&
 & P_U,P_PU,P_TU,PDELTA,ZDELTA,ZZA,ZAR,ZCOEF,ZZTAU)

...
CALL DELTA_C(KIDIA,KFDIA,KLON,KTDIA-1,ZP,PT(:,KTDIA),ZDU,&
 & ZC_UW,ZC_US,ZC_US_IRHOV,ZC_UC,ZC_U,ZC_PU,ZC_TU,&
 & ZDEOTA0(:,KTDIA-1),YDPHY,YDPHY3,ZTRLI,ZIRHOV(:,KTDIA-1))
CALL DELTA_T(KIDIA,KFDIA,KLON,KTDIA-1,ZP,PT(:,KTDIA),ZDU,&
 & ZT_UW,ZT_US,ZT_US_IRHOV,ZT_UC,ZT_U,ZT_PU,ZT_TU,&
 & ZDEOTA1(:,KTDIA-1),YDPHY,YDPHY3,ZTRLI,ZIRHOV(:,KTDIA-1))
DO JLON=KIDIA,KFDIA
...
DO JLEV=KTDIA,KLEV
  ...
  ! compute total and incremental optical depths
  CALL DELTA_C(KIDIA,KFDIA,KLON,JLEV,PAPRSF(:,JLEV),PT(:,JLEV),ZDU,&
   & ZC_UW,ZC_US,ZC_US_IRHOV,ZC_UC,ZC_U,ZC_PU,ZC_TU,&
   & ZDEOTA0(:,JLEV),YDPHY,YDPHY3,ZTRLI,ZIRHOV(:,JLEV))
  CALL DELTA_T(KIDIA,KFDIA,KLON,JLEV,PAPRSF(:,JLEV),PT(:,JLEV),ZDU,&
   & ZT_UW,ZT_US,ZT_US_IRHOV,ZT_UC,ZT_U,ZT_PU,ZT_TU,&
   & ZDEOTA1(:,JLEV),YDPHY,YDPHY3,ZTRLI,ZIRHOV(:,JLEV))
  DO JLON=KIDIA,KFDIA
...
DO JLEV=KLEV,KTDIA,-1
  ...
  CALL DELTA_C(KIDIA,KFDIA,KLON,JLEV,PAPRSF(:,JLEV),PT(:,JLEV),ZDU,&
   & ZC_UW,ZC_US,ZC_US_IRHOV,ZC_UC,ZC_U,ZC_PU,ZC_TU,&
   & ZUEOTA0(:,JLEV),YDPHY,YDPHY3,ZTRLI,ZIRHOV(:,JLEV))
  CALL DELTA_T(KIDIA,KFDIA,KLON,JLEV,PAPRSF(:,JLEV),PT(:,JLEV),ZDU,&
   & ZT_UW,ZT_US,ZT_US_IRHOV,ZT_UC,ZT_U,ZT_PU,ZT_TU,&
   & ZUEOTA1(:,JLEV),YDPHY,YDPHY3,ZTRLI,ZIRHOV(:,JLEV))
  DO JLON=KIDIA,KFDIA
...
CALL DELTA_C(KIDIA,KFDIA,KLON,KTDIA-1,ZP,PT(:,KTDIA),ZDU,&
 & ZC_UW,ZC_US,ZC_US_IRHOV,ZC_UC,ZC_U,ZC_PU,ZC_TU,&
 & ZUEOTA0(:,KTDIA-1),YDPHY,YDPHY3,ZTRLI,ZIRHOV(:,KTDIA-1))
CALL DELTA_T(KIDIA,KFDIA,KLON,KTDIA-1,ZP,PT(:,KTDIA),ZDU,&
 & ZT_UW,ZT_US,ZT_US_IRHOV,ZT_UC,ZT_U,ZT_PU,ZT_TU,&
 & ZUEOTA1(:,KTDIA-1),YDPHY,YDPHY3,ZTRLI,ZIRHOV(:,KTDIA-1))
DO JLON=KIDIA,KFDIA
  PUEOTI(JLON,KTDIA-1)=&
...
IF ( .NOT.LDAUTO ) THEN
  ...
  DO JLEV1=KTDIA-1,KLEV-1  ! initial half level
    ...
    DO JLEV2=JLEV1+1,ILEV  ! final half level
      ...
      CALL DELTA_C(KIDIA,KFDIA,KLON,JLEV2,PAPRSF(:,JLEV2),PT(:,JLEV2),ZDU,&
       & ZC_UW,ZC_US,ZC_US_IRHOV,ZC_UC,ZC_U,ZC_PU,ZC_TU,&
       & ZDEL0,YDPHY,YDPHY3,ZTRLI,ZIRHOV(:,JLEV2))
      CALL DELTA_T(KIDIA,KFDIA,KLON,JLEV2,PAPRSF(:,JLEV2),PT(:,JLEV2),ZDU,&
       & ZT_UW,ZT_US,ZT_US_IRHOV,ZT_UC,ZT_U,ZT_PU,ZT_TU,&
       & ZDEL1,YDPHY,YDPHY3,ZTRLI,ZIRHOV(:,JLEV2))
  ...
  DO JLEV=KTDIA,KLEV
    ...
    CALL DELTA_C(KIDIA,KFDIA,KLON,JLEV,PAPRSF(:,JLEV),PT(:,JLEV),ZDU,&
     & ZC_UW,ZC_US,ZC_US_IRHOV,ZC_UC,ZC_U,ZC_PU,ZC_TU,&
     & ZDEL0,YDPHY,YDPHY3,ZTRLI,ZIRHOV(:,JLEV))
    CALL DELTA_T(KIDIA,KFDIA,KLON,JLEV,PAPRSF(:,JLEV),PT(:,JLEV),ZDU,&
     & ZT_UW,ZT_US,ZT_US_IRHOV,ZT_UC,ZT_U,ZT_PU,ZT_TU,&
     & ZDEL1,YDPHY,YDPHY3,ZTRLI,ZIRHOV(:,JLEV))
...
SUBROUTINE DELTA_C(KIDIA,KFDIA,KLON,KL,PRES,PT,PDU,PUW,PUS,PUS_IRHOV,PUC,&
 & P_U,P_PU,P_TU,PDELTA,YDPHY,YDPHY3,PTRLI,PIRHOV)
...
REAL   (KIND=JPRB), INTENT(IN)    :: PIRHOV   (KLON)
...
DO JG=1,3
  DO JLON=KIDIA,KFDIA
    ...
    PUS_IRHOV(JLON,JG)=PUS_IRHOV(JLON,JG)+PIRHOV(JLON)*&
...
SUBROUTINE DELTA_T(KIDIA,KFDIA,KLON,KL,PRES,PT,PDU,PUW,PUS,PUS_IRHOV,PUC,&
 & P_U,P_PU,P_TU,PDELTA,YDPHY,YDPHY3,PTRLI,PIRHOV)

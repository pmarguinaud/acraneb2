...
IF ( .NOT.YDPHY%LCLSATUR ) THEN
  ...
  ENDDO
IF (JLON==33) PRINT *, " PBSFTL 1 = ", PBSFTL(JLON,47)
...
IF (JLON==33.AND.JLEV==47) THEN
  PRINT *, " PQL  = ", PQL(JLON,JLEV)
  PRINT *, " LLQL = ", LLQL(JLON,JLEV)
ENDIF
   ENDDO
...
IF (JLON==33.AND.JB==2.AND.JLEV==47) THEN
  PRINT *, " LLQL = ", LLQL(JLON,JLEV)
ENDIF
        ...
        ENDIF
IF (JLON==33.AND.JB==2.AND.JLEV==47) PRINT *, " ZRE1 = ", ZRE1(JLON,47,2)
...
IF (JLON==33) PRINT *, " ZGL 1 = ", ZGL(JLON,47,2)
  ...
  DO JB=1,YDPHY3%N_SPBAND
   ...
   ! OUTPUT:    
    ...
    DO JLEV=KTDIA,KLEV
          ...
          ZSIZE_=ZRE1(JLON,JLEV,JB)
IF (JLEV==47.AND.JLON==33.AND.JB==2) THEN
  PRINT *, " ZSIZE_ = ", ZSIZE_
ENDIF
...
ENDIF
    ...
    ENDDO
IF (JLON==33.AND.JB==2) PRINT *, " ZGL 2 = ", ZGL(JLON,47,2)
    ...
    ENDDO
IF (JLON==33.AND.JB==2) PRINT *, " ZGL 3 = ", ZGL(JLON,47,2)
...
IF (JLON==33) PRINT *, " ZGL = ", ZGL(JLON,47,2)
  ! thermal band
  JB=2
  DO JLEV=KTDIA,KLEV
  ...
  ENDDO
IF (JLON==33) PRINT *, " PBSFTL 2 = ", PBSFTL(JLON,47)

...
IF (JLON==33) PRINT *, " PFMC 1 = ", PFMC(JLON,0)
...
!-------------------------------------------------------------------------------
  ...
  ENDIF
IF (JLON==33) PRINT *, " PFDN 1 = ", PFDN(JLON,KLEV)

IF (JLON==33) PRINT *, " PFMC 2 = ", PFMC(JLON,0)
...
IF (JLON==33.AND.JLEV==47) THEN
  PRINT *, JLEV
  PRINT *, " PFMN = ", PFMN(JLON,JLEV-1)
  PRINT *, " PA5N = ", PA5N(JLON,JLEV)
  PRINT *, " ZBE2 = ", ZBE2
  PRINT *, " PFDC = ", PFDC(JLON,JLEV-1)
  PRINT *, " ZDE2 = ", ZDE2
  PRINT *, " PFDN = ", PFDN(JLON,JLEV-1)
  PRINT *, " ZTD2 = ", ZTD2
  PRINT *, " PFMC = ", PFMC(JLON,JLEV-1)
  PRINT *, " ZTD3 = ", ZTD3
  PRINT *, " PFMN = ", PFMN(JLON,JLEV-1)
ENDIF
...
IF (JLON==33.AND.JLEV==47) THEN
  PRINT *, " PFDC = ", JLEV, PFDC(JLON,JLEV-1)
  PRINT *, " PA4C = ", PA4C(JLON,JLEV)
  PRINT *, " ZAL2 = ", ZAL2
  PRINT *, " PFDC = ", PFDC(JLON,JLEV-1)
  PRINT *, " ZGA2 = ", ZGA2
  PRINT *, " PFDN = ", PFDN(JLON,JLEV-1)
...
IF (JLON==33) THEN
  PRINT *, " PFDC = ", JLEV, PFDC(JLON,JLEV)
ENDIF
...
IF (JLEV==KLEV.AND.JLON==33) THEN
  PRINT *, " xxx "
  PRINT *, " PFDN = ", PFDN(JLON,JLEV)
  PRINT *, " PA4N = ", PA4N(JLON,JLEV)
  PRINT *, " ZBE2 = ", ZBE2
  PRINT *, " PFDC = ", PFDC(JLON,JLEV-1)
  PRINT *, " ZDE2 = ", ZDE2
  PRINT *, " PFDN = ", PFDN(JLON,JLEV-1)
...
ENDDO
IF (JLON==33) PRINT *, " PFDN 2 = ", PFDN(JLON,KLEV)

IF (JLON==33) PRINT *, " PFMC 3 = ", PFMC(JLON,0)
...
IF (JLON==33) PRINT *, " PFMC 4 = ", PFMC(JLON,0)


! I.4 - BACK-SUBSTITUTION LAYER BY LAYER.
!-------------------------------------------------------------------------------

IF (JLON==33) PRINT *, " YDPHY%LRNUMX = ", YDPHY%LRNUMX

IF (JLON==33) PRINT *, " PFMC = ", PFMC(JLON,0)
IF (JLON==33) PRINT *, " PFMN = ", PFMN(JLON,0)

IF (JLON==33) PRINT *, " ZTU1 = ", ZTU1(JLON,1)
IF (JLON==33) PRINT *, " ZTU2 = ", ZTU2(JLON,1)
IF (JLON==33) PRINT *, " ZTU3 = ", ZTU3(JLON,1)
IF (JLON==33) PRINT *, " ZTU4 = ", ZTU4(JLON,1)
IF (JLON==33) PRINT *, " ZTU5 = ", ZTU5(JLON,1)
IF (JLON==33) PRINT *, " ZTU6 = ", ZTU6(JLON,1)
IF (JLON==33) PRINT *, " ZTU7 = ", ZTU7(JLON,1)
IF (JLON==33) PRINT *, " ZTU8 = ", ZTU8(JLON,1)
IF (JLON==33) PRINT *, " ZTU9 = ", ZTU9(JLON,1)

IF (JLON==33) PRINT *, " PFDN 3 = ", PFDN(JLON,KLEV)
...
IF (JLON==33) THEN
  PRINT *, JLEV
  PRINT *, PFDN(JLON,JLEV)
  PRINT *, ZTU8(JLON,JLEV)
  PRINT *, PFMC(JLON,JLEV)
  PRINT *, ZTU9(JLON,JLEV)
  PRINT *, PFMN(JLON,JLEV)
ENDIF
...
IF (JLON==33) THEN
  PRINT *, JLEV 
  PRINT *, PFDN(JLON,JLEV) 
  PRINT *, PFDC(JLON,JLEV)
  PRINT *, PFMN(JLON,JLEV-1)
  PRINT *, PFMC(JLON,JLEV-1)
ENDIF

IF (JLEV==1 .AND. JLON == 33) THEN
  PRINT *, "---"
  PRINT *, " PFMC = ", PFMC(JLON,JLEV-1)
  PRINT *, " ZTU2 = ", ZTU2(JLON,JLEV)
  PRINT *, " PFMC = ", PFMC(JLON,JLEV)
  PRINT *, " ZTU3 = ", ZTU3(JLON,JLEV)
  PRINT *, " PFMN = ", PFMN(JLON,JLEV)
  PRINT *, " ZTU1 = ", ZTU1(JLON,JLEV)
  PRINT *, " PFMN = ", PFMN(JLON,JLEV-1)
  PRINT *, "---"
ENDIF
...
IF (JLON==33) PRINT *, " PFMC 5 = ", PFMC(JLON,0)

...
IF (JLON==33) PRINT *, " ZBSFTN = ", ZBSFTN(JLON,47)
IF (JLON==33) PRINT *, " ZEODTN = ", ZEODTN(JLON,47)
...
ENDDO
IF (JLON==33) PRINT *, " ZEO2TN = ", ZEO2TN(JLON,47)
...
IF (JLON==33) PRINT *, " ZA5N 1 = ", ZA5N(JLON,47)
...
IF (JLON==33) PRINT *, " ZFMC 1 = ", ZFMC(JLON,0)
  IF (YDML_PHY_MF%YRPHY%LRNUMX) THEN
...
ENDDO
IF (JLON==33) PRINT *, " ZFMC 2 = ", ZFMC(JLON,0)
...
IF (JLON==33) PRINT *, " ZFMC 3 = ", ZFMC(JLON,0)
...
IF (JLON==33) PRINT *, " ZFMC = ", ZFMC(JLON,0)
...
IF (JLON==33) PRINT *, " ZA5N 2 = ", ZA5N(JLON,47)
IF (JLON==33) PRINT *, " ZFDN = ", ZFDN(JLON,KLEV)
CALL ACRANEB_SOLVT(YDML_PHY_MF%YRPHY,KIDIA,KFDIA,KLON,KTDIA,KLEV,&
 & PEMIS,PNEB,ZB1,ZB2,ZB3,ZB4,ZA4C,ZA5C,ZA4N,ZA5N,&
 & ZFDC,ZFMC,ZFDN,ZFMN, YLSTACK)
...
PFRSO(JLON,0)=0._JPRB

IF (JLON==33) PRINT *, PFRSO(JLON,0)
IF (JLON==33) PRINT *, " ZFPC = ", ZFPC(JLON,0)
IF (JLON==33) PRINT *, " ZFDC = ", ZFDC(JLON,0)
IF (JLON==33) PRINT *, " ZFMC = ", ZFMC(JLON,0)
IF (JLON==33) PRINT *, " ZFPN = ", ZFPN(JLON,0)
IF (JLON==33) PRINT *, " ZFDN = ", ZFDN(JLON,0)
IF (JLON==33) PRINT *, " ZFMN = ", ZFMN(JLON,0)

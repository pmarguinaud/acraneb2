...
IF (JLON==33) PRINT *, " PEO2TN = ", PEO2TN(JLON,47)
IF (JLON==33) PRINT *, " PA5N 1 = ", PA5N(JLON,47)
...
IF (JLON==33.AND.JLEV==47)THEN
  PRINT *, " ZEO2   = ", ZEO2
  PRINT *, " PEO2TN = ", PEO2TN(JLON,JLEV)
  PRINT *, " PDELP  = ", PDELP(JLON,JLEV)
  PRINT *, " PQLI   = ", PQLI(JLON,JLEV)
  PRINT *, " PEO2TI = ", PEO2TI(JLON,JLEV)
  PRINT *, " PQICE  = ", PQICE(JLON,JLEV)
ENDIF
...
IF (JLON==33) PRINT *, " PA5N 2 = ", PA5N(JLON,47)

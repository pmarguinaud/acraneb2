...
REAL(KIND=JPRB) :: ZAL,ZTD1,ZTD2,ZTD3,ZTD4,ZTD5,ZTD6,ZTD7,ZTDS1,ZTDS2,&
                 & ZTDS3,ZTUS1,ZHOOK_HANDLE

temp(REAL(KIND=JPRB),ZAL1,(KLON))
temp(REAL(KIND=JPRB),ZAL2,(KLON))
temp(REAL(KIND=JPRB),ZBE1,(KLON))
temp(REAL(KIND=JPRB),ZBE2,(KLON))
temp(REAL(KIND=JPRB),ZDE1,(KLON))
temp(REAL(KIND=JPRB),ZDE2,(KLON))
temp(REAL(KIND=JPRB),ZGA1,(KLON))
temp(REAL(KIND=JPRB),ZGA2,(KLON))

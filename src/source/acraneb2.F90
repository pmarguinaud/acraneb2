...
ELSE
  ...
  ENDDO
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, ZEOXT(JLON,1)
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, PGEOLT(JLON,1)
  DO JLEV=KTDIA-1,KLEV
...
IF ( (YDML_PHY_MF%YRPHY%NRAUTOEV == 0.AND.ICALT == 1).OR.ICALT == 2 ) THEN
  ...
  ENDDO
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, ZTAUL(JLON,1)
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, ZEOXT(JLON,1)
  ...
  DO JLEV1=KTDIA-1,KLEV      ! initial half level
    ...
    ENDDO
  ENDDO
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, ZTAU(JLON,0,1)
...
IF (JLEV1==0.AND.JLEV2==1) THEN
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, ZTAU(JLON,0,1)
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, ZTAU(JLON,JLEV1,JLEV2-1)
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, ZTAUL(JLON,JLEV2)
ENDIF
...
IF (JLEV1==1.AND.JLEV2==2) THEN
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, JLEV1, JLEV2, ZFLUXE
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, ZBB(JLON,JLEV2-1)
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, ZBB(JLON,JLEV1-1)
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, ZTAU(JLON,JLEV1,JLEV2  )
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, ZTAU(JLON,JLEV1-1,JLEV2  )
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, ZTAU(JLON,JLEV1,JLEV2-1)
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, ZTAU(JLON,JLEV1-1,JLEV2-1)
...
IF (JLEV == 1) THEN
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, ZFLUXL(JLON,JLEV)
ENDIF
...
IF (JLEV == 1) THEN
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, YDML_PHY_MF%YRPHY3%RMIXP0
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, ZEPS1
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, ZFLUXD(JLON,JLEV)
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, ZFLUXL(JLON,JLEV)
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, ZFLUXR(JLON,JLEV)
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, ZW 
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, " ZMIXP = ",  ZMIXP (1, 1)
ENDIF
...
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, " PFRTH = ", PFRTH (1, 1)
...
IF (JLEV-1==1) THEN
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, " ZZTRTH = ", ZZTRTH(JLON,JLEV-1)
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, " ZMIXP = ", ZMIXP(JLON,JLEV-1)
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, " ZZFRTH = ", ZZFRTH(JLON,JLEV-1)
IF (JLON == 1) PRINT *, __FILE__, ':', __LINE__, " PFRTH = ", PFRTH (1, 1)
ENDIF

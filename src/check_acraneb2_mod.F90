...
REAL(KIND=JPRB) :: TOLERANCE=1.E-14
...
DO JBLK=1,KGPBLK
  DO JLEV=0,KLEV
    DO JLON=1,KLON
      ...
      IF ( ABS( PFRSO(JLON,JLEV,JBLK) - PFRSO_OUT(JLON_OUT,JLEV) ) / &
       ...
       & > TOLERANCE ) THEN
        IF ( LLFIRST ) THEN
          ...
          LLALLOK=.FALSE.
        ENDIF
        WRITE (*,'(5X,3I5,3E16.8)') JLON,JLEV,JBLK,PFRSO(JLON,JLEV,JBLK), &
...
DO JBLK=1,KGPBLK
  DO JLEV=0,KLEV
    DO JLON=1,KLON
      JLON_OUT=MODULO(JLON-1,KLON_OUT)+1
      IF ( ABS( PFRTH(JLON,JLEV,JBLK) - PFRTH_OUT(JLON_OUT,JLEV) ) / &
       ...
       & > TOLERANCE ) THEN
        IF ( LLFIRST ) THEN
          ...
          LLALLOK=.FALSE.
        ENDIF
        WRITE (*,'(5X,3I5,3E16.8)') JLON,JLEV,JBLK,PFRTH(JLON,JLEV,JBLK), &
...
DO JBLK=1,KGPBLK
  DO JLON=1,KLON
    JLON_OUT=MODULO(JLON-1,KLON_OUT)+1
    IF ( ABS( PFRSODS(JLON,JBLK) - PFRSODS_OUT(JLON_OUT) ) /&
      ...
      IF ( LLFIRST ) THEN
        ...
        LLALLOK=.FALSE.
      ENDIF
      WRITE (*,'(5X,2I5,3E16.8)') JLON,JBLK,PFRSODS(JLON,JBLK),&
...
DO JBLK=1,KGPBLK
  DO JLON=1,KLON
    JLON_OUT=MODULO(JLON-1,KLON_OUT)+1
    IF ( ABS( PFRSOPS(JLON,JBLK) - PFRSOPS_OUT(JLON_OUT) ) / &
      ...
      IF ( LLFIRST ) THEN
        ...
        LLALLOK=.FALSE.
      ENDIF
      WRITE (*,'(5X,2I5,3E16.8)') JLON,JBLK,PFRSOPS(JLON,JBLK), &
...
DO JBLK=1,KGPBLK
  DO JLON=1,KLON
    JLON_OUT=MODULO(JLON-1,KLON_OUT)+1
    IF ( ABS( PFRSOLU(JLON,JBLK) - PFRSOLU_OUT(JLON_OUT) ) / &
       & MAX( ABS( PFRSOLU(JLON,JBLK) ), ABS( PFRSOLU_OUT(JLON_OUT) ) )&
       &  > TOLERANCE ) THEN
      IF ( LLFIRST ) THEN
        WRITE (*,*) '  PFRSOLU :'
        LLFIRST=.FALSE.
        LLALLOK=.FALSE.
      ENDIF
      WRITE (*,'(5X,2I5,3E16.8)') JLON,JBLK,PFRSOLU(JLON,JBLK), &
...
DO JBLK=1,KGPBLK
  DO JLON=1,KLON
    JLON_OUT=MODULO(JLON-1,KLON_OUT)+1
    IF ( ABS( PFRTHDS(JLON,JBLK) - PFRTHDS_OUT(JLON_OUT) ) / &
      ...
      IF ( LLFIRST ) THEN
        ...
        LLALLOK=.FALSE.
      ENDIF
      WRITE (*,'(5X,2I5,3E16.8)') JLON,JBLK,PFRTHDS(JLON,JBLK), &

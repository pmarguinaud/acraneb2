...
! local arrays of contained subroutine
...
DO JLON=KIDIA,KFDIA
CALL DELTA_S(JLON,KTDIA-1,LL_DESC,ZP,PT(:,KTDIA),ZDU,&
...
DO JLEV=KTDIA,KLEV
  ...
  ! (solar incremental multiplied by 2.mu0)
  DO JLON=KIDIA,KFDIA
	CALL DELTA_S(JLON,JLEV,LL_DESC,PAPRSF(1,JLEV),PT(1,JLEV),ZDU,&
   & ZS_UW,ZS_US,ZS_US_IRHOV,ZS_UC,ZS_U,ZS_PU,ZS_TU,&
   & ZDEOSA(1,JLEV))
	ENDDO
	DO JLON=KIDIA,KFDIA
...
SUBROUTINE DELTA_S(JLON,KL,LD_DESC,PRES,PT,PDU,PUW,PUS,PUS_IRHOV,PUC,&

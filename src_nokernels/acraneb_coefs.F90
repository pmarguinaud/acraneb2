...
!$acc data &
!$acc& present(YDPHY3,LDMASKS,PAPRSF,PDELP,PQICE,PQLI,PDEOS,PEODSI,PEODSN,&
!$acc& PEOSI,PEOSIUN,PEOSN,PEOSNUN,&
!$acc& PEO1SI,PEO1SN,PEO2SI,PEO2SN,PUEOS,PUSI,PUSN,&
!$acc& PEOSA,PEOSAUN,PEO1SA,PEO2SA,PEO3SA,PEO4SA,&
!$acc& PMU0I,&
